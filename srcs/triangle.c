...
int	add_tr(t_array *arr, char **ptr)
{
	...
	return (create_element(ptr, (t_tuple2[]){{&el->o1, a_to_v},
...
{
	double m11 = get_norm2(u);
	double m12 = scalar_p(u, v);
	double m22 = get_norm2(v);
	double detm = m11 * m22 - m12 * m12;
	double b11 = scalar_p(w, u);
	double b21 = scalar_p(w, v);
